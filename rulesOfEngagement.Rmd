...
On www.heart.dk/github/programming guidance there is a document "Good programming practice". It is necessary to study this and adhere to most suggestions to save your own time and not to get in the way of other users.

The basic data structure of projects on Statistics Denmark changes as projects are moved to the "Danmarks Data Vindue" structure in Statistics Denmark.  The document "Basic Data Structure" describes where files can be found.
