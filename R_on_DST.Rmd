...
library(data.table)
library(ggplot2)
setDT(dt <- mpg) #toy dataset described [here](https://ggplot2.tidyverse.org/reference/mpg.html)
...
```
The possibles are endless and we can suggest using the help page [The R graph gallery](https://www.r-graph-gallery.com/index.html) as inspiration or our very own demonstration at [Introduction to ggplot](https://heart.dk/wp-content/uploads/2020/04/introduction_to_ggplot.html).
