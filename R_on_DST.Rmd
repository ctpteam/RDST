...
```
# New additions
January 2024: Description of the rleid function and how to get RStudio start up quickly
...
Occationally you will find that a package does not work with the latest installment of R.  In such cases you can from RStudio global options select an earlier version of R.
