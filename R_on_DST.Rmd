...
A standard start up of RStudio in Statistics Denmark is very slow. The reason is the creation of the "Packages pane".  And this is slow because CRAN has been enabled in total. To get a quick start you should disable this option in Global option - Packages - Management where the "v" in "Enable package pane" should be removed.
