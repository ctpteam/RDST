...
smaller datasets arrow is simpler.  Note that the very simple "read" functions from arrow/nanoparquet only works on parquet objects that are single files.  One advantage of arrow is that the open_dataset() function works equally on single file and directories of chunks.
```{r,eval=FALSE}    
set_cpu_count(5) # If relevant for arrow to paralellize reading
